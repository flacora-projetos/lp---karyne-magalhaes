...
export const YouTubeSection = () => {
  return (
    <section className="py-16 bg-primary-beige/30 border-t border-border-gray/30">
      <div className="max-w-4xl mx-auto px-6 text-center">
        ...
        <p className="text-base md:text-lg text-secondary-green leading-relaxed mb-10 max-w-2xl mx-auto">
        ...
        <a 
          ...
          className="inline-flex items-center gap-2 px-8 py-3.5 rounded-full border border-primary-brown/20 bg-primary-white text-primary-brown font-medium hover:bg-primary-beige hover:border-primary-brown/30 transition-all shadow-sm"
        >
