...
begin
  ...
  on conflict (lead_id) do update set
    ...
    meta_fbp             = coalesce(public.leads.meta_fbp, excluded.meta_fbp),
    meta_fbc             = coalesce(public.leads.meta_fbc, excluded.meta_fbc),
    client_ip            = coalesce(public.leads.client_ip, excluded.client_ip);
end;
$function$;
